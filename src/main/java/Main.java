    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Observable.range(1, 10).takeLast(3)
            .subscribe(it -> println("TakeLast: " + it)).unsubscribe();
        println();
        ...
        Observable.merge(odds, evens).subscribe(it -> println("Merge: " + it)).unsubscribe();
        println();

        // StartWith
        Observable.from(Arrays.asList(1, 2, 3, 4, 5))
            .startWith(0)
            .subscribe(it -> println("startWith: " + it)).unsubscribe();
        println();
        ...
        Observable.zip(numberOb, stringOb, (n, s) -> String.format("%d%s", n, s))
            .subscribe(it -> println("zip: " + it)).unsubscribe();
        println();
        ...
        joinNumbers.join(
            ...
            (n, s) -> n + "-" + s
        ).subscribe(it -> println("Join: " + it)).unsubscribe();
        println();
    }
}
